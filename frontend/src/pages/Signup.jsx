    ...
    {message}
        ...
        <div className="relative flex w-1/2 flex-col items-center">
          ...
          <img
            src={Features}
            alt="Features"
            className="absolute bottom-20 z-10 h-[190px] w-[300px]"
          />
        </div>

        {/* Right Section */}
        <div className="flex h-full w-1/2 flex-col gap-4 p-10 pt-15">
          <h1 className="text-4xl font-extrabold text-white">
            Create <br />
            New Account<span className="text-blue-600">.</span>
          </h1>

          <form 
           onSubmit={submitHandler}
           className="flex h-[75%] w-4/5 flex-col items-center justify-center gap-5">

            {/* Username */}
            <div className="relative flex h-13 w-full flex-col rounded-xl bg-white/10 px-3 backdrop-blur-2xl transition-all duration-200 hover:scale-[1.03]">
